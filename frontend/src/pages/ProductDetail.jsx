...
function ProductDetail() {
  ...
  return (
    <div>
      {/* Product Section */}
      <div className="w-[99vw] h-[130vh] md:h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex flex-col lg:flex-row gap-[20px]">
        
        {/* Image Gallery */}
        <div className="lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex flex-col-reverse lg:flex-row items-center justify-center gap-[30px] md:gap-[10px]">
          <div className="lg:w-[20%] md:w-[80%] lg:h-[80%] h-[10%] flex flex-wrap lg:flex-col items-center justify-center gap-[20px] lg:gap-[20px]">
            {images.map((img, index) => (
              <div key={index} className="md:w-[100px] w-[50px] h-[50px] md:h-[110px] bg-slate-300 border border-[#80808049] rounded-md">
                <img
                  src={img}
        ...
        {/* Product Info */}
        <div className="lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex flex-col items-start justify-start gap-[10px] py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-0 lg:px-0 lg:py-0">
      ...
      <div className="w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex flex-col items-start justify-start overflow-x-hidden">
        <div className="flex px-[20px] mt-[90px] lg:ml-[80px] lg:mt-0">
